...
def analysis():
    ...
    def ab_prints(msg,a):
        ...
        tt2.grid(row = 4 ,column = 3)
        tt1.grid(row = 3 ,column = 3)
        #text=tk.Text(txt)
...
def predict():
    ...
    def pb_prints(msg,a):
        ...
        tt1=tk.Message(txt,text=msg,relief=tk.RAISED,anchor=tk.W,width=300)
        tt1.grid(row = 1 ,column = 3)
        tt2=tk.Message(txt,text=a,relief=tk.RAISED,anchor=tk.W,width=200)
        tt2.grid(row = 2 ,column = 3)
        #text=tk.Text(txt)
        #text.insert(tk.END,msg)
        #text.insert(tk.END,a)
        #text.grid()    
    ...
    def pb3():
       ...
       # year = int(z1.get())
        ...
        comboboxMonth.grid(padx=20,pady=20)
    ...
    pb0.grid(row = 4 ,column = 3)

    
    top2.mainloop()    
    
button1 = tk.Button(r,text='Analysis',width=50,height=5,command=analysis)
button1.config(font=("Ariel",20))
button1.grid(row = 1 ,column = 3)

button2= tk.Button(r,text='Prediction',width=50,height=5,command=predict)
button2.config(font=("Ariel",20))
button2.grid(row = 2 ,column = 3)

button3= tk.Button(r,text='Exit',width=50,height=5,command=r.destroy)
